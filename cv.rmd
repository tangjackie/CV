...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/tangjackie/CV/raw/master/jackietang_cv.pdf)")
}
```
...
- <i class="fab fa-SAS"></i> SAS
- <i class="fab fa-SAS"></i> SQL
...
The source code is available [on github.com/nstrayer/cv](https://github.com/tangjackie/CV).
...
Certificate {data-icon=book data-concise=true}
--------------------------------------------------------------------------------
